                    ...
                    <div className="bg-card shadow-sm sm:rounded-lg">
                        <form onSubmit={submit} className="p-6">
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-foreground">Password (leave blank to keep current)</label>
                                ...
                                <div>
                                    ...
                                    <textarea value={data.bio} onChange={(e) => setData('bio', e.target.value)} rows={3} className={inputClass} />
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-foreground">Timezone</label>
                                    <input type="text" value={data.timezone} onChange={(e) => setData('timezone', e.target.value)} placeholder="UTC" className={inputClass} />
                                </div>
